...
func (uc *UsersCreate) SetUserStatus(i int) *UsersCreate {
	uc.mutation.SetUserStatus(i)
	return uc
}

// SetNillableUserStatus sets the "user_status" field if the given value is not nil.
func (uc *UsersCreate) SetNillableUserStatus(i *int) *UsersCreate {
	if i != nil {
		uc.SetUserStatus(*i)
	}
	return uc
...
func (uc *UsersCreate) SetUserRole(s string) *UsersCreate {
	uc.mutation.SetUserRole(s)
	return uc
}

// SetNillableUserRole sets the "user_role" field if the given value is not nil.
func (uc *UsersCreate) SetNillableUserRole(s *string) *UsersCreate {
	if s != nil {
		uc.SetUserRole(*s)
	}
	return uc
...
func (uc *UsersCreate) check() error {
	...
	if _, ok := uc.mutation.UserStatus(); !ok {
		return &ValidationError{Name: "user_status", err: errors.New(`ent: missing required field "Users.user_status"`)}
	}
	...
	if _, ok := uc.mutation.UserRole(); !ok {
		return &ValidationError{Name: "user_role", err: errors.New(`ent: missing required field "Users.user_role"`)}
	}
	if _, ok := uc.mutation.UpdatedAt(); !ok {
